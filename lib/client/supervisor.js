...
p._watchHashChange = function() {

  var self = this;

  function hashChangeHandler() {
    var appName = global.window.location.hash.slice(2);
    self._loadApp(appName);
  }

  $(global.window).on('hashchange', hashChangeHandler);
